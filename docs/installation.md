...
```json
{
  "plugin": ["supertester@git+https://github.com/your-org/supertester.git"]
}
```
...
```json
{
  "plugin": ["supertester@git+https://github.com/your-org/supertester.git#v0.1.0"]
}
```
...
```bash
claude plugin add https://github.com/your-org/supertester.git
```
...
- 报告问题：https://github.com/your-org/supertester/issues
- 主文档：https://github.com/your-org/supertester
